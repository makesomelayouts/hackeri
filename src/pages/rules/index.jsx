                ...
                <div className="lg:col-span-2 text-sm text-gray-200 space-y-3">
                  ...
                  <ul className="list-disc ml-6 mt-2 space-y-2 text-sm">
                    <li>
                      ...
                      количеством коинов теряет один, два или три из них...
                    </li>
                    <li>
                      Страница не найдена: игрок с наибольшим количеством
                      зарядов теряет один, два или три заряда...
                    </li>
                    <li>
                      Лабиринт страха: если наименьшая разыгранная карта равна
                      3, все теряют по одному коину...
                    </li>
                  </ul>
                  ...
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <img
                        src={trap4}
                        alt="card small 4"
                        className="w-14 object-contain rounded-md shadow-sm"
                      />
                      <img
                        src={trap5}
                        alt="card small 5"
                ...
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="flex justify-center">
                    <img
                      src={big_trap}
                      alt="Карта памяти"
                      className="w-64 h-80 object-contain rounded-2xl border border-[rgba(255,255,255,0.05)] shadow-lg"
                    />
                  </div>
                </div>
              </div>
